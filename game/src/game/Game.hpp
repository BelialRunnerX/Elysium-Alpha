...
private:
    static constexpr int PlanetCount = 8;
    ...
    bool titleScreen_{true};
    bool cinematicHud_{true};
    float worldTimeOfDay_{0.22f};
    ...
    void drawCinematicAtmosphere(const PlanetEnvironment& env, Vec3 cameraPos, Vec3 upHint);
    void drawAmbientParticles(const PlanetEnvironment& env, Vec3 focus, Vec3 upHint);
    Color skyColorForTime(const PlanetEnvironment& env) const;
