...
public final class ElysiumContent {
    ...
    private static void registerOres() {
        ElysiumHooks.registerOre(Elysium.NEUTRONIUM_ORE.get(), true);
        ElysiumHooks.registerOre(Elysium.AETHERIUM_ORE.get(), false);
        ElysiumHooks.registerOre(Elysium.VOIDGLASS_ORE.get(), false);
    }
