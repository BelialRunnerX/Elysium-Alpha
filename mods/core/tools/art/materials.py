...
# Lightness for steps 1..5, matching the curve the hand-painted ramps use:
# a dark body, a mid mass, and a highlight that stops well short of white.
_STEPS = [0.10, 0.19, 0.29, 0.41, 0.56]
